    ...
    coffee:
      compile:
        files:
          ...
          'lib/viff.utils.js': 'src/viff.utils.coffee',
          'lib/webdriver.js': 'src/webdriver.coffee',
          ...
          'test/build/viff.utils.spec.js': 'test/src/viff.utils.spec.coffee',
          'test/build/webdriver.spec.js': 'test/src/webdriver.spec.coffee',
